...
public class IntelliJ {
    ...
    public static void generateFrom(Configuration c) throws IOException {
        String ipr = Files.toString(ClassLoader.getSystemResourceAsStream("templates/" + IDEA_IPR));
        Files.toFile(ipr, new File(IDEA_IPR));

        String iml = Files.toString(ClassLoader.getSystemResourceAsStream("templates/" + IDEA_IML));
